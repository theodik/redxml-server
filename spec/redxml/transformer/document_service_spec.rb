...
RSpec.describe RedXML::Server::Transformer::DocumentService do
  ...
  before do
    ...
    @doc_service = RedXML::Server::Transformer::DocumentService.new(@db_interface, "1", "2")
  end

  it 'test_get_possible_id' do
  ...
  # it 'test_generate_sax_events' do
  #   file = File.absolute_path(FILE_PATH)
  #   name = File.basename(file)
  #   @doc_service.save_document(file)
  #   coll = XMLDBApi::RedCollection.new("1", "2", "coll")
  ...
  it 'test_get_all_documents_ids' do
    file = File.absolute_path(FILE_PATH)
    name = File.basename(file)
    @doc_service.save_document(file)
  ...
  it 'test_get_all_documents_names' do
    file = File.absolute_path(FILE_PATH)
    name = File.basename(file)
    @doc_service.save_document(file)
