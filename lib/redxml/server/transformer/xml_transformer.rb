    ...
    module Transformer
      ...
      class XMLTransformer
        ...
        def initialize(db_interface, key_builder)
          ...
          @mapping_service = Transformer::MappingService.new(db_interface, key_builder)
        ...
        def generate_node_sax_events(key_elem_builder)
          ...
          fields_only.each_with_index do |field, index|
            ...
            if parts[0] == "xmlns" #Namespace declaration
              ...
              fail StandardError, "XML is not a valid document, attribute used undeclared namespace" unless attr_uri
